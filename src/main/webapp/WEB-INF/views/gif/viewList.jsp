        ...
        <div class="search_wrap pt0">
            ...
            <div class="content_box">
                <div class="gallery_section">
                    ...
                    <p class="search_results">움직이는 이미지 리스트</p>
                    ...
                    <ul class="gallery_content" id="galleryContent">
                        <c:forEach items="${thumbnailList}" var="thumb">
                            <li class="fade-in thumb-item" data-idx="${thumb.gifIdx}">
                                <img src="${thumb.presignedUrl}" alt="이미지">
                                <div class="hover_content">
                                    <div class="check_box">
                                        <label for="${thumb.gifIdx}" style="color: white"><c:out value="${thumb.name}"/></label>
                                    </div>
                                </div>
                            </li>
                        </c:forEach>
